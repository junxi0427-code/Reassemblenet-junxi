...
def update_arg_parser(args):
    ...
    if args.dataset=='crosscut' or  args.dataset =='voronoi' or  args.dataset =='repair':
...
def create_model_and_diffusion(
    ...
    model = TransformerModel(input_channels, condition_channels, num_channels, 
                             out_channels, use_checkpoint, rotation, use_image_features, 
                             use_geometry_only,
                             use_global_texture_only,
                             use_local_texture_only,
                                use_geometry_and_global_texture,
